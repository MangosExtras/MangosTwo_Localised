...
SET `achievement_reward`.`subject`=COALESCE(`locales_achievement_reward`.`subject_loc2`,`locales_achievement_reward`.`subject_loc0`),
SET `achievement_reward`.`text`=COALESCE(`locales_achievement_reward`.`text_loc2`,`locales_achievement_reward`.`text_loc0`);
