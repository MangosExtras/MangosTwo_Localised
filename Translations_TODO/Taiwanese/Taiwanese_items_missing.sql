...
UPDATE `locales_item` SET `description_loc5`='Teaches Conjure Mana Gem (Rank 2).' WHERE `entry`=8840;
UPDATE `locales_item` SET `description_loc5`='The completed amulet of Rakh\'likh.' WHERE `entry`=10757;
