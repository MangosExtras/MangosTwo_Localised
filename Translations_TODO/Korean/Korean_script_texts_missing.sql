...
UPDATE trans_words SET content_loc1='Follow me, $N. I\'ll take you to the Defias hideout. But you better protect me or I am as good as dead' WHERE word_id = 7;
...
UPDATE trans_words SET content_loc1='$N coming in fast! Prepare to fight!' WHERE word_id = 10;
UPDATE trans_words SET content_loc1='Ok, Lets move out!' WHERE word_id = 13;
...
UPDATE trans_words SET content_loc1='Falcon Watch, at last! Now, where\'s my... Oh no! My pack, it\'s missing! Where has -' WHERE word_id = 27;
UPDATE trans_words SET content_loc1='Ready when you are, $c.' WHERE word_id = 29;
...
UPDATE trans_words SET content_loc1='We need you to send reinforcements to Manaforge Duro, Ardonis. This is not a request, it\'s an order.' WHERE word_id = 34;
...
UPDATE trans_words SET content_loc1='We\'ve had too many setbacks along the way: Hellfire Citadel, Fallen Sky Ridge, Firewing Point... Prince Kael\'thas will tolerate no further delays. I will tolerate nothing other than complete success!' WHERE word_id = 40;
...
UPDATE trans_words SET content_loc1='Avruu\'s magic... it still controls me. You must fight me, mortal. It\'s the only way to break the spell!' WHERE word_id = 44;
UPDATE trans_words SET content_loc1='Avruu\'s magic is broken! I\'m free once again!' WHERE word_id = 45;
UPDATE trans_words SET content_loc1='There\'s Farstrider Enclave now, $C. Not far to go... Look out! Troll ambush!!' WHERE word_id = 49;
...
UPDATE trans_words SET content_loc1='Invaders, you dangle upon the precipice of oblivion! The Burning Legion comes and with it comes your end.' WHERE word_id = 63;
UPDATE trans_words SET content_loc1='Do not proceed. You will be eliminated!' WHERE word_id = 1329;
UPDATE trans_words SET content_loc1='Muahahahaha! You fool! You\'ve released me from my banishment in the interstices between space and time!' WHERE word_id = 66;
...
UPDATE trans_words SET content_loc1='Good $N, you are under the spell\'s influence. I must analyze it quickly, then we can talk.' WHERE word_id = 71;
UPDATE trans_words SET content_loc1='The last thing I remember is the ship falling and us getting into the pods. I\'ll go see how I can help. Thank you!' WHERE word_id = 73;
UPDATE trans_words SET content_loc1='$C, Where am I? Who are you? Oh no! What happened to the ship?' WHERE word_id = 74;
UPDATE trans_words SET content_loc1='$C You saved me! I owe you a debt that I can never repay. I\'ll go see if I can help the others.' WHERE word_id = 75;
UPDATE trans_words SET content_loc1='Ugh... what is this place? Is that all that\'s left of the ship over there?' WHERE word_id = 76;
...
UPDATE trans_words SET content_loc1='%s looks down at the discarded necklace. In her sadness, the lady incants a glamour, which beckons forth Highborne spirits. The chamber resonates with their ancient song about the Sin\'dorei...' WHERE word_id = 1338;
UPDATE trans_words SET content_loc1='%s kneels down and pick up the amulet.' WHERE word_id = 93;
UPDATE trans_words SET content_loc1='Please tell me that you didn\'t just do what I think you just did. Please tell me that I\'m not going to have to hurt you...' WHERE word_id = 95;
...
UPDATE trans_words SET content_loc1='Very well. Let\'s see what you have to show me, $N.' WHERE word_id = 104;
...
UPDATE trans_words SET content_loc1='Follow me, stranger. This won\'t take long.' WHERE word_id = 129;
...
UPDATE trans_words SET content_loc1='They were drawn to the ruins of Shattrath City where a small remnant of the draenei priesthood conducted its rites inside a ruined temple on this very spot.' WHERE word_id = 135;
...
UPDATE trans_words SET content_loc1='It wouldn\'t be long, however, before the city came under attack once again. This time, the attack came from Illidan\'s armies. A large regiment of blood elves had been sent by Illidan\'s ally, Kael\'thas Sunstrider, to lay waste to the city.' WHERE word_id = 137;
UPDATE trans_words SET content_loc1='As the regiment of blood elves crossed this very bridge, the Aldor\'s exarchs and vindicators lined up to defend the Terrace of Light. But then the unexpected happened.' WHERE word_id = 138;
UPDATE trans_words SET content_loc1='The defection of Voren\'thal and his followers was the largest loss ever incurred by Kael\'s forces. And these weren\'t just any blood elves. Many of the best and brightest amongst Kael\'s scholars and magisters had been swayed by Voren\'thal\'s influence.' WHERE word_id = 141;
...
UPDATE trans_words SET content_loc1='The Aldor\'s most holy temple and its surrounding dwellings lie on the terrace above. As a holy site, only the initiated are welcome inside.' WHERE word_id = 145;
...
UPDATE trans_words SET content_loc1='Such is their animosity that they vie for the honor of being sent to assist the naaru there. Each day, that decision is made here by A\'dal. The armies gather here to receive A\'dal\'s blessing before heading to Shadowmoon.' WHERE word_id = 148;
UPDATE trans_words SET content_loc1='Khadgar should be ready to see you again. Just remember that to serve the Sha\'tar you will most likely have to ally with the Aldor or the Scryers. And seeking the favor of one group will cause the others\' dislike.' WHERE word_id = 149;
...
UPDATE trans_words SET content_loc1='I\'ll begin drawing energy from the stone. Your job, $N, is to defend me. This place is cursed... trust me.' WHERE word_id = 160;
...
UPDATE trans_words SET content_loc1='A $C attacks!' WHERE word_id = 202;
UPDATE trans_words SET content_loc1='Beware! I am under attack!' WHERE word_id = 203;
...
UPDATE trans_words SET content_loc1='It\'s good to see you again, Erland. What is your report?' WHERE word_id = 207;
UPDATE trans_words SET content_loc1='Hello, Quinn. How are you faring?' WHERE word_id = 210;
UPDATE trans_words SET content_loc1='I\'ve been better. Ivar the Foul got the better of me...' WHERE word_id = 211;
...
UPDATE trans_words SET content_loc1='Something tells me this $r wants the mysterious fossil too. Help!' WHERE word_id = 233;
UPDATE trans_words SET content_loc1='Is the way clear? Let\'s get out while we can, $N.' WHERE word_id = 237;
UPDATE trans_words SET content_loc1='Looks like we won\'t get away so easy. Get ready!' WHERE word_id = 238;
UPDATE trans_words SET content_loc1='Let\'s keep moving. We\'re not safe here!' WHERE word_id = 239;
UPDATE trans_words SET content_loc1='Look out, $N! Enemies ahead!' WHERE word_id = 240;
UPDATE trans_words SET content_loc1='We\'re almost to the refuge! Let\'s go.' WHERE word_id = 241;
...
UPDATE trans_words SET content_loc1='Looks like the Southsea Freeboters are heavily entrenched on the coast. This could get rough.' WHERE word_id = 1341;
UPDATE trans_words SET content_loc1='Help! $C attacking!' WHERE word_id = 268;
UPDATE trans_words SET content_loc1='$C heading this way fast! Time for revenge!' WHERE word_id = 269;
UPDATE trans_words SET content_loc1='$C coming right at us!' WHERE word_id = 270;
UPDATE trans_words SET content_loc1='Get this $C off of me!' WHERE word_id = 271;
...
UPDATE trans_words SET content_loc1='Rin\'ji will tell you secret now... $n, should go to the Overlook Cliffs. Rin\'ji hid something on island  there' WHERE word_id = 302;
...
UPDATE trans_words SET content_loc1='Be on the alert! The Blackwood furbolgs are numerous in the area...' WHERE word_id = 336;
...
UPDATE trans_words SET content_loc1='Danger. Danger! $c try hurt A-Me.' WHERE word_id = 344;
UPDATE trans_words SET content_loc1='Bad, $c. $c, bad!' WHERE word_id = 345;
...
UPDATE trans_words SET content_loc1='Let us leave this place. I\'ve had enough of these madmen!' WHERE word_id = 369;
UPDATE trans_words SET content_loc1='Beware! More cultists come!' WHERE word_id = 371;
...
UPDATE trans_words SET content_loc1='A newcomer to Shattrath! Make sure to drop by later. We can always use a hand with the injured.' WHERE word_id = 382;
UPDATE trans_words SET content_loc1='Are you joking? I\'m a Scryer, I always watch what i say. More enemies than allies in this city, it seems.' WHERE word_id = 384;
UPDATE trans_words SET content_loc1='Light be with you, $n. And welcome to Shattrath.' WHERE word_id = 385;
UPDATE trans_words SET content_loc1='We\'re rather selective of who we befriend, $n. You think you have what it takes?' WHERE word_id = 386;
...
UPDATE trans_words SET content_loc1='At your command, my liege...' WHERE word_id = 424;
...
UPDATE trans_words SET content_loc1='%s follows $n obediertly.' WHERE word_id = 434;
...
UPDATE trans_words SET content_loc1='Enough! I will teach you some manners, wench!' WHERE word_id = 2463;
UPDATE trans_words SET content_loc1='My wounds are grave. Forgive my slow pace but my injuries won\'t allow me to walk any faster.' WHERE word_id = 445;
UPDATE trans_words SET content_loc1='Ah, fresh air, at last! I need a moment to rest.' WHERE word_id = 446;
UPDATE trans_words SET content_loc1='The Blackrock infestation is thick in these parts. I will do my best to keep the pace. Let\'s go!' WHERE word_id = 447;
...
UPDATE trans_words SET content_loc1='Niby, you\' re an idiot.' WHERE word_id = 453;
...
UPDATE trans_words SET content_loc1='Look out! The $c attacks!' WHERE word_id = 461;
...
UPDATE trans_words SET content_loc1='Yay! We\'re free!' WHERE word_id = 469;
...
UPDATE trans_words SET content_loc1='Do not test me, scurvy dog! I\'m trained in the way of the Blood Knights!' WHERE word_id = 471;
UPDATE trans_words SET content_loc1='I\'ll pay! I\'ll pay! Eeeek! Please don\'t hurt me!' WHERE word_id = 472;
...
UPDATE trans_words SET content_loc1='Hello? Help?' WHERE word_id = 486;
UPDATE trans_words SET content_loc1='Don\'t leave me in here! Cause if you do I will find you!' WHERE word_id = 487;
UPDATE trans_words SET content_loc1='You sure you\'re ready? Take a moment.' WHERE word_id = 489;
...
UPDATE trans_words SET content_loc1='To Nighthaven! Keep your army close, champion. ' WHERE word_id = 508;
...
UPDATE trans_words SET content_loc1='Who is the predictable one, beast? Surely you did not think that we would summon you on top of Malfurion? Your redemption comes, Eranikus. You will be cleansed of this madness - this corruption.' WHERE word_id = 517;
...
UPDATE trans_words SET content_loc1='Seek absolution, Eranikus. All will be forgiven...' WHERE word_id = 529;
...
UPDATE trans_words SET content_loc1='Enu thora\'serador. This is a sacred place.' WHERE word_id = 559;
UPDATE trans_words SET content_loc1='We will show you...' WHERE word_id = 560;
UPDATE trans_words SET content_loc1='Look above you; thara dormil dorah...' WHERE word_id = 561;
UPDATE trans_words SET content_loc1='It was on that day that the wildkin were given to us. Fierce guardians, the goddess assigned the wildkin to protect all of her sacred places.' WHERE word_id = 566;
UPDATE trans_words SET content_loc1='Anu\'dorini Talah, Ru shallora enudoril.' WHERE word_id = 567;
UPDATE trans_words SET content_loc1='But now, many years later, the wildkin have grown more feral, and without the guidance of the goddess, they are confused...' WHERE word_id = 568;
UPDATE trans_words SET content_loc1='Without a purpose, they wander... But many find their way back to the sacred areas that they once were sworn to protect.' WHERE word_id = 569;
...
UPDATE trans_words SET content_loc1='Lord Staghelm, where are you going? You would shatter our bond for the sake of pride?' WHERE word_id = 604;
...
UPDATE trans_words SET content_loc1='Let\'s go $N!' WHERE word_id = 609;
...
UPDATE trans_words SET content_loc1='Thanks $N. Now let\'s get out of here!' WHERE word_id = 619;
UPDATE trans_words SET content_loc1='We made it! Thanks again! I\'m going to run ahead!' WHERE word_id = 620;
UPDATE trans_words SET content_loc1='Hey Hornizz! I\'m back! And there are some people behind me who helped me out of a jam.' WHERE word_id = 621;
UPDATE trans_words SET content_loc1='We\'re going to have to scratch the Maraudines off our list. Too hard to work with...' WHERE word_id = 622;
UPDATE trans_words SET content_loc1='Well, I\'m off to the Gelkis. They\'re not as dumb as the Maraudines, but they\'re more reasonable.' WHERE word_id = 623;
...
UPDATE trans_words SET content_loc1='Don\'t give up! Fight, to the death!' WHERE word_id = 628;
UPDATE trans_words SET content_loc1='OK boss, I get back to tree hitting.' WHERE word_id = 629;
...
UPDATE trans_words SET content_loc1='Beware $N! Look to the west!' WHERE word_id = 724;
UPDATE trans_words SET content_loc1='Kolkar invaders are retreating!' WHERE word_id = 726;
UPDATE trans_words SET content_loc1='Kolkar are the strongest!' WHERE word_id = 727;
UPDATE trans_words SET content_loc1='With this much void waste and run off, a toxic void horror can\'t be too far behind.' WHERE word_id = 1347;
UPDATE trans_words SET content_loc1='Look there, fleshling! Salhadaar\'s conduits! He\'s keeping well fed...' WHERE word_id = 1348;
UPDATE trans_words SET content_loc1='Alright, keep me protected while I plant this disruptor. This shouldn\'t take very long...' WHERE word_id = 1349;
...
UPDATE trans_words SET content_loc1='You must protect me from monsters, who are living in this forest!' WHERE word_id = 741;
UPDATE trans_words SET content_loc1='This part of forest are very danger for us. We must be a careful!' WHERE word_id = 742;
UPDATE trans_words SET content_loc1='Kill two monsters, who stay near Bogbean plant and then I gather a bogbean.' WHERE word_id = 743;
UPDATE trans_words SET content_loc1='Help! The beast is on me!' WHERE word_id = 2542;
UPDATE trans_words SET content_loc1='I am gathering a bogbean. It takes some time.' WHERE word_id = 744;
UPDATE trans_words SET content_loc1='Thanks you for help.' WHERE word_id = 1280;
...
UPDATE trans_words SET content_loc1='We\'ll start at that first energy pylon, straight ahead. Remember, try to keep them off of me.' WHERE word_id = 2549;
UPDATE trans_words SET content_loc1='I\'m done with this pylon. On to the next.' WHERE word_id = 2551;
...
UPDATE trans_words SET content_loc1='Thank you, $n! I couldn\'t have done it without you. You\'ll let Gahruj know?' WHERE word_id = 2554;
...
UPDATE trans_words SET content_loc1='Thanks for your help. Let\'s get out of here!' WHERE word_id = 2577;
UPDATE trans_words SET content_loc1='Let\'s keep moving. I don\'t like this place.' WHERE word_id = 2578;
...
UPDATE trans_words SET content_loc1='I think it\'s up this way to the left. Let\'s go!' WHERE word_id = 2587;
UPDATE trans_words SET content_loc1='Quickly, catch your breaths before we press for the gate!' WHERE word_id = 2600;
UPDATE trans_words SET content_loc1='You couldn\'t have come at a better time! Let\'s get out of here.' WHERE word_id = 2634;
...
UPDATE trans_words SET content_loc1='Don\'t shoot! Apothecary coming through!' WHERE word_id = 2641;
...
UPDATE trans_words SET content_loc1='Oh, I wandered off again. I\'m sorry.' WHERE word_id = 2680;
UPDATE trans_words SET content_loc1='I\'m so glad yer back Shay. Please, don\'t ever run off like that again! What would I tell yer parents if I lost ya?' WHERE word_id = 2684;
UPDATE trans_words SET content_loc1='Come, $N! Let\'s go over there and collect it!' WHERE word_id = 2709;
UPDATE trans_words SET content_loc1='I\'m glad you\'re here! Because I need your help!!' WHERE word_id = 2710;
UPDATE trans_words SET content_loc1='Look out! The $N attacks!' WHERE word_id = 2455;
...
UPDATE trans_words SET content_loc1='You will not stop me from escaping here, $N!' WHERE word_id = 1284;
...
UPDATE trans_words SET content_loc1='Spare my life! I will tell you about Arelion\'s secret.' WHERE word_id = 4108;
UPDATE trans_words SET content_loc1='Your moldering remains will serve ME as a testament to what happens when one is foolish enough to trespass in my domain!
' WHERE word_id = 763;
UPDATE trans_words SET content_loc1='But what does it matter. It is time for this to end.' WHERE word_id = 2726;
...
UPDATE trans_words SET content_loc1='We\'re under attack!  A vast, ye swabs! Repel the invaders!' WHERE word_id = 772;
UPDATE trans_words SET content_loc1='You land lubbers are tougher than I thought! I\'ll have to improvise!' WHERE word_id = 773;
UPDATE trans_words SET content_loc1='This $N is a minion from Naralex\'s nightmare no doubt!.' WHERE word_id = 787;
...
UPDATE trans_words SET content_loc1='Okay, here we go. It\'s going to take about five minutes to shut this thing down through the ritual. Once I start, keep the vermin off of me or it will be the end of us all!' WHERE word_id = 851;
UPDATE trans_words SET content_loc1='You\'ll rue the day you crossed me, $N' WHERE word_id = 852;
...
UPDATE trans_words SET content_loc1='Just two minutes to go! We\'re half way there, but don\'t let your guard down!' WHERE word_id = 855;
UPDATE trans_words SET content_loc1='One more minute! Hold on now, the ritual is about to take hold!' WHERE word_id = 856;
UPDATE trans_words SET content_loc1='That\'s it -- we made it! The ritual is set in motion, and idol fires are about to go out for good! You truly are the heroes I thought you would be!' WHERE word_id = 857;
...
UPDATE trans_words SET content_loc1='Here\'s my body, fit and pure! Now, your blackened souls I\'ll cure!' WHERE word_id = 1371;
...
UPDATE trans_words SET content_loc1='You can\'t hide from us. Prepare to burn!' WHERE word_id = 1300;
...
UPDATE trans_words SET content_loc1='Try the boar! It\'s my new recipe!' WHERE word_id = 1307;
UPDATE trans_words SET content_loc1='Enjoy! You won\'t find better ale anywhere!' WHERE word_id = 1308;
UPDATE trans_words SET content_loc1='Drink up! There\'s more where that came from!' WHERE word_id = 1309;
UPDATE trans_words SET content_loc1='Have you tried the Dark Iron Ale? It\'s the best!' WHERE word_id = 1310;
UPDATE trans_words SET content_loc1='Hey! Get away from that!' WHERE word_id = 1312;
UPDATE trans_words SET content_loc1='That\'s it! You\'re going down!' WHERE word_id = 1314;
UPDATE trans_words SET content_loc1='That\'s it! No more beer until this mess is sorted out!' WHERE word_id = 1315;
...
UPDATE trans_words SET content_loc1='The time has come! Gul\'dan, order your warlocks to double their efforts! Moments from now the gateway will open, and your Horde will be released upon this ripe, unsuspecting world!' WHERE word_id = 1402;
...
UPDATE trans_words SET content_loc1='You dare set foot upon Hakkari holy ground? Minions of Hakkar, destroy the infidels!' WHERE word_id = 958;
...
UPDATE trans_words SET content_loc1='One of the Ash\'ari Crystals has been destroyed! Slay the intruders!' WHERE word_id = 969;
...
UPDATE trans_words SET content_loc1='You\'re still here? Your foolishness is amusing! The Argent Dawn wench needn\'t suffer in vain. Leave at once and she shall be spared!' WHERE word_id = 974;
UPDATE trans_words SET content_loc1='I shall take great pleasure in taking this poor wretch\'s life! It\'s not too late, she needn\'t suffer in vain. Turn back and her death shall be merciful!' WHERE word_id = 975;
UPDATE trans_words SET content_loc1='May this prisoner\'s death serve as a warning. None shall defy the Scourge and live!' WHERE word_id = 976;
UPDATE trans_words SET content_loc1='You did it... you\'ve slain Baron Rivendare! The Argent Dawn shall hear of your valiant deeds!' WHERE word_id = 979;
...
UPDATE trans_words SET content_loc1='These mortal infidels, my lord! They have invaded your sanctum, and seek to steal your secrets!' WHERE word_id = 992;
...
UPDATE trans_words SET content_loc1='Impudent whelps! You\'ve rushed headlong to your own deaths! See now, the master stirs!' WHERE word_id = 1006;
UPDATE trans_words SET content_loc1='The demon is loose! Quickly we must restrain him!' WHERE word_id = 1007;
UPDATE trans_words SET content_loc1='None of your kind should be here! You\'ve doomed only yourselves!' WHERE word_id = 1010;
UPDATE trans_words SET content_loc1='Clever Mortals but I am not so easily lured away from my sanctum!' WHERE word_id = 1011;
UPDATE trans_words SET content_loc1='Ah...the heroes. You are persistent, aren\'t you? Your ally here attempted to match his power against mine - and paid the price. Now he shall serve me...by slaughtering you.' WHERE word_id = 1016;
...
UPDATE trans_words SET content_loc1='Too late, friends! Nefarius\' corruption has taken hold...I cannot...control myself.' WHERE word_id = 1036;
...
UPDATE trans_words SET content_loc1='Nefarius\' hate has made me stronger than ever before! You should have fled while you could, mortals! The fury of Blackrock courses through my veins!' WHERE word_id = 1039;
...
UPDATE trans_words SET content_loc1='Get up, little red wyrm...and destroy them!' WHERE word_id = 1042;
...
UPDATE trans_words SET content_loc1='No longer will we wait behind barred doors and walls of stone! No longer will our vengeance be denied! The dragons themselves will tremble before our wrath!' WHERE word_id = 1053;
UPDATE trans_words SET content_loc1='Staghelm will whimper and beg for his life, just as his whelp of a son did! One thousand years of injustice will end this day!' WHERE word_id = 1055;
UPDATE trans_words SET content_loc1='Fandral! Your time has come! Go and hide in the Emerald Dream and pray we never find you!' WHERE word_id = 1056;
...
UPDATE trans_words SET content_loc1='You are not worth my time $N!' WHERE word_id = 1062;
...
UPDATE trans_words SET content_loc1='Sands of the desert rise and block out the sun!' WHERE word_id = 1072;
...
UPDATE trans_words SET content_loc1='You will be judged for defiling these sacred grounds! The laws of the Ancients will not be challenged! Trespassers will be annihilated!' WHERE word_id = 1086;
UPDATE trans_words SET content_loc1='Come, little ones.' WHERE word_id = 1095;
...
UPDATE trans_words SET content_loc1='Come, Midnight, let\'s disperse this petty rabble!' WHERE word_id = 1415;
...
UPDATE trans_words SET content_loc1='Don\'t let them hurt us, Tito! Oh, you won\'t, will you?' WHERE word_id = 1437;
...
UPDATE trans_words SET content_loc1='Guess I\'m not so rusty, after all.' WHERE word_id = 1448;
...
UPDATE trans_words SET content_loc1='Welcome, Ladies and Gentlemen, to this evening\'s presentation!' WHERE word_id = 1522;
...
UPDATE trans_words SET content_loc1='You\'ve got my attention, dragon. You\'ll find I\'m not as easily scared as the villagers below.' WHERE word_id = 1527;
UPDATE trans_words SET content_loc1='Your dabbling in the arcane has gone too far, Medivh. You\'ve attracted the attention of powers beyond your understanding. You must leave Karazhan at once!' WHERE word_id = 1528;
...
UPDATE trans_words SET content_loc1='A dark power seeks to use you, Medivh! If you stay, dire days will follow. You must hurry, we don\'t have much time!' WHERE word_id = 1530;
UPDATE trans_words SET content_loc1='I do not know what you speak of, dragon... but I will not be bullied by this display of insolence. I\'ll leave Karazhan when it suits me!' WHERE word_id = 1531;
...
UPDATE trans_words SET content_loc1='What have you done, wizard? This cannot be! I\'m burning from... within!' WHERE word_id = 1534;
UPDATE trans_words SET content_loc1='He should not have angered me. I must go... recover my strength now...' WHERE word_id = 1535;
...
UPDATE trans_words SET content_loc1='I\'m gonna enjoy killin\' these slack-jawed daffodils!' WHERE word_id = 1173;
...
UPDATE trans_words SET content_loc1='Bow to the might of the Highlord!' WHERE word_id = 1189;
...
UPDATE trans_words SET content_loc1='I...am...released! Perhaps it\'s not too late to ' WHERE word_id = 1193;
...
UPDATE trans_words SET content_loc1='Our preparations continue as planned master.' WHERE word_id = 1202;
...
UPDATE trans_words SET content_loc1='It is good that you serve me so faithfully. Soon... all will serve the Lich King and in the end, you shall be rewarded. So long as you do not falter.' WHERE word_id = 1203;
...
UPDATE trans_words SET content_loc1='I foresee no complications at this... wait! What is this!?' WHERE word_id = 1204;
...
UPDATE trans_words SET content_loc1='Your security measures have failed! See to this interruption immediately!' WHERE word_id = 1205;
UPDATE trans_words SET content_loc1='Invaders...here?! DESTROY them, Kel\'Thuzad! Naxxramas must not fall!' WHERE word_id = 2741;
UPDATE trans_words SET content_loc1='Yes, master!' WHERE word_id = 1206;
...
UPDATE trans_words SET content_loc1='Your petty magics are no challenge to the might of the Scourge! ' WHERE word_id = 1224;
...
UPDATE trans_words SET content_loc1='Uraaa...' WHERE word_id = 1561;
...
UPDATE trans_words SET content_loc1='You wish to fight us all at once? This should be amusing!' WHERE word_id = 1575;
...
UPDATE trans_words SET content_loc1='I\'m tired. You kill next one!' WHERE word_id = 1612;
...
UPDATE trans_words SET content_loc1='The Alliance dares to intrude this far into my fortress? Bring out the Honor Hold prisoners and call for the executioner! They\'ll pay with their lives for this trespass!' WHERE word_id = 1624;
...
UPDATE trans_words SET content_loc1='Anara\'nel belore!' WHERE word_id = 1795;
UPDATE trans_words SET content_loc1='For...Quel...thalas!' WHERE word_id = 1797;
...
UPDATE trans_words SET content_loc1='I knew the prince would be angry but, I... I have not been myself. I had to let them out! The great one speaks to me, you see. Wait--outsiders. Kael\'thas did not send you! Good... I\'ll just tell the prince you released the prisoners!' WHERE word_id = 1831;
...
UPDATE trans_words SET content_loc1='%s focuses on $N' WHERE word_id = 1975;
...
UPDATE trans_words SET content_loc1='I have set back the flow of time just once more. If you fail to prevent Thrall\'s death, then all is lost.' WHERE word_id = 1978;
...
UPDATE trans_words SET content_loc1='Taretha\'s life hangs in the balance. Surely you care for her. Surely you wish to save her...' WHERE word_id = 1989;
...
UPDATE trans_words SET content_loc1='As long as we\'re going with a new plan, I may aswell pick up a weapon and some armor.' WHERE word_id = 1997;
...
UPDATE trans_words SET content_loc1='Taretha...' WHERE word_id = 2008;
UPDATE trans_words SET content_loc1='A good day...to die...' WHERE word_id = 2009;
UPDATE trans_words SET content_loc1='This day is long overdue. Out of my way!' WHERE word_id = 2011;
UPDATE trans_words SET content_loc1='They call you a monster. But they\'re the monsters, not you. Farewell Thrall.' WHERE word_id = 2025;
...
UPDATE trans_words SET content_loc1='Come out from the shadows! I\'ve returned to lead you against our true enemy! Shed your chains and raise your weapons against your Illidari masters!' WHERE word_id = 2046;
...
UPDATE trans_words SET content_loc1='Diel fin\'al' WHERE word_id = 2110;
...
UPDATE trans_words SET content_loc1='We\'ve come to end your reign, Illidan. My people and all of Outland shall be free!' WHERE word_id = 2127;
...
UPDATE trans_words SET content_loc1='???' WHERE word_id = 2757;
...
UPDATE trans_words SET content_loc1='Ingvar! Your pathetic failure will serve as a warning to all... you are damned! Arise and carry out the masters will!' WHERE word_id = 2766;
...
UPDATE trans_words SET content_loc1=' ' WHERE word_id = 2785;
...
UPDATE trans_words SET content_loc1='I\'ll mount your skull from the highest tower!' WHERE word_id = 2794;
UPDATE trans_words SET content_loc1='ARGH! You call that... an attack? I\'ll... show... aghhhh...' WHERE word_id = 2795;
...
UPDATE trans_words SET content_loc1='You have failed your people!' WHERE word_id = 2804;
UPDATE trans_words SET content_loc1='There is a reason I am king!' WHERE word_id = 2805;
...
UPDATE trans_words SET content_loc1='The end has come! ' WHERE word_id = 2308;
UPDATE trans_words SET content_loc1='Choke on your final breath! ' WHERE word_id = 2309;
UPDATE trans_words SET content_loc1='I am stronger than ever before! ' WHERE word_id = 2310;
UPDATE trans_words SET content_loc1='No more hesitation! Your fates are written! ' WHERE word_id = 2311;
...
UPDATE trans_words SET content_loc1='As the Legion\'s final defeat draws ever-nearer, stand proud in the knowledge that you have saved worlds without number from the flame.' WHERE word_id = 2366;
UPDATE trans_words SET content_loc1='Just as this day marks an ending, so too does it herald a new beginning...' WHERE word_id = 2367;
...
UPDATE trans_words SET content_loc1='In time, the light and hope held within - will rebirth more than this mere fount of power... Mayhap, they will rebirth the soul of a nation.' WHERE word_id = 2373;
...
UPDATE trans_words SET content_loc1='Well, aren\'t you lucky?' WHERE word_id = 2391;
...
UPDATE trans_words SET content_loc1='Don\'t look so smug! I know what you\'re thinking, but Tempest Keep was merely a set back. Did you honestly believe I would trust the future to some blind, half-night elf mongrel?' WHERE word_id = 2400;
...
UPDATE trans_words SET content_loc1='Oh, no! Adventurers, something awful has happened! A colleague of mine has been captured by the Infinite Dragonflight, and they\'re doing something horrible to him! Keeping Arthas is still your highest priority, but if you act fast you could help save a Guardian of Time!' WHERE word_id = 2862;
...
UPDATE trans_words SET content_loc1='You shouldn\'t have come...now you will die!' WHERE word_id = 2906;
...
UPDATE trans_words SET content_loc1='Soon, the Master\'s voice will call to you.' WHERE word_id = 3003;
...
UPDATE trans_words SET content_loc1='BURN! Burn in the makers fire!' WHERE word_id = 3082;
UPDATE trans_words SET content_loc1='Arise, soldiers of the Iron Crucible! The Makers\' will be done!' WHERE word_id = 3084;
...
UPDATE trans_words SET content_loc1='Begin uplink: Reply Code: \'Omega\'. Planetary re-origination requested.' WHERE word_id = 3170;
...
UPDATE trans_words SET content_loc1='\'Hodir\'s Fury\' online. Acquiring target.' WHERE word_id = 3218;
UPDATE trans_words SET content_loc1='\'Mimiron\'s Inferno\' online. Acquiring target.' WHERE word_id = 3219;
UPDATE trans_words SET content_loc1='\'Thorim\'s Hammer\' online. Acquiring target.' WHERE word_id = 3220;
UPDATE trans_words SET content_loc1='\'Freya\'s Ward\' online. Acquiring target.' WHERE word_id = 3221;
...
UPDATE trans_words SET content_loc1='Now why would you go and do something like that? Didn\'t you see the sign that said \'DO NOT PUSH THIS BUTTON!\'? How will we finish testing with the self-destruct mechanism active?' WHERE word_id = 3225;
UPDATE trans_words SET content_loc1='Oh, my! It would seem that we are out of time, my friends!' WHERE word_id = 3226;
UPDATE trans_words SET content_loc1='We haven\'t much time, friends! You\'re going to help me test out my latest and greatest creation. Now, before you change your minds, remember, that you kind of owe it to me after the mess you made with the XT-002.' WHERE word_id = 3227;
...
UPDATE trans_words SET content_loc1='A thousand deaths... ' WHERE word_id = 3276;
...
UPDATE trans_words SET content_loc1='Da ground gonna swallow you up! ' WHERE word_id = 3327;
...
UPDATE trans_words SET content_loc1='You don\'t stand a chance, $n' WHERE word_id = 3396;
UPDATE trans_words SET content_loc1='$N, I\'d recognize that face anywhere... What... What have they done to ye, $Glad:lass;?' WHERE word_id = 3411;
UPDATE trans_words SET content_loc1='$N, I\'d recognize those horns anywhere... What have they done to you, $N?' WHERE word_id = 3413;
...
UPDATE trans_words SET content_loc1='A pact was made, $Gbrother:sister;! We vowed vengeance against the Lich King! For what he had done to us! We battled the Scourge as Forsaken, pushing them back into the plaguelands and freeing Tirisfal! You and I were champions of the Forsaken!' WHERE word_id = 3424;
UPDATE trans_words SET content_loc1='You must remember the splendor of life, $Gbrother:sister;. You were a champion of the Kaldorei once! This isn\'t you!' WHERE word_id = 3425;
UPDATE trans_words SET content_loc1='Think, $N. Think back. Try and remember the majestic halls of Silvermoon City, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the sin\'dorei once! This isn\'t you.' WHERE word_id = 3426;
UPDATE trans_words SET content_loc1='Think, $N. Think back. Try and remember the proud mountains of Argus, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the draenei once! This isn\'t you.' WHERE word_id = 3427;
UPDATE trans_words SET content_loc1='Think, $N. Think back. Try and remember the snow capped mountains o\' Dun Morogh! Ye were born there, $Glad:lass;. Remember the splendor o\' life, $N! Ye were a champion o\' the dwarves once! This isn\'t ye!' WHERE word_id = 3428;
...
UPDATE trans_words SET content_loc1='Think, $N. Think back. Try and remember the hills and valleys of Elwynn, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the Alliance once! This isn\'t you.' WHERE word_id = 3430;
UPDATE trans_words SET content_loc1='Think, $N. Think back. Try and remember Durotar, $Gbrother:sister;! Remember the sacrifices our heroes made so that we could be free of the blood curse. Harken back to the Valley of Trials, where we were reborn into a world without demonic influence. We found the splendor of life, $N. Together! This isn\'t you. You were a champion of the Horde once!' WHERE word_id = 3431;
UPDATE trans_words SET content_loc1='Think, $N. Think back. Try and remember the rolling plains of Mulgore, where you were born. Remember the splendor of life, $Gbrother:sister;. You were a champion of the tauren once! This isn\'t you.' WHERE word_id = 3432;
...
UPDATE trans_words SET content_loc1='There... There\'s no more time for me. I\'m done for. FInish me off, $N. Do it or they\'ll kill us both. $N...Remember Elwynn. This world is worth saving.' WHERE word_id = 3444;
...
UPDATE trans_words SET content_loc1='When next we meet it won\'t be on holy ground, paladin.' WHERE word_id = 3529;
UPDATE trans_words SET content_loc1='Rise, Darion, and listen...' WHERE word_id = 3530;
...
UPDATE trans_words SET content_loc1='And while such things can never be forgotten, we must remain vigilant in our cause!' WHERE word_id = 3532;
...
UPDATE trans_words SET content_loc1='The Argent Dawn and the Order of the Silver Hand will come together as one! We will succeed where so many before us have failed!' WHERE word_id = 3535;
...
UPDATE trans_words SET content_loc1='The Argent Crusade comes for you, Arthas!' WHERE word_id = 3537;
...
UPDATE trans_words SET content_loc1='You are easily bested! ' WHERE word_id = 3561;
...
UPDATE trans_words SET content_loc1='A lone orc, against the might of the Alliance?' WHERE word_id = 3708;
...
UPDATE trans_words SET content_loc1='%s gasps for air' WHERE word_id = 3720;
UPDATE trans_words SET content_loc1='What in the... There, in the distance!' WHERE word_id = 3722;
...
UPDATE trans_words SET content_loc1='Bah! Muradin, secure the deck and prepare our soldiers for an assault on the upper citadel. I\'ll send out another regiment from Stormwind.' WHERE word_id = 3734;
...
UPDATE trans_words SET content_loc1='Bad news, everyone! I don\'t think I\'m going to make it' WHERE word_id = 3770;
...
UPDATE trans_words SET content_loc1='Now feel my master\'s limitless power and despair!' WHERE word_id = 3821;
...
UPDATE trans_words SET content_loc1='First, you must escape Frostmourne\'s hold, or be damned as I am; trapped within this cursed blade for all eternity.' WHERE word_id = 3837;
...
UPDATE trans_words SET content_loc1='%s dies' WHERE word_id = 3858;
...
UPDATE trans_words SET content_loc1='Show them no mercy, Horde champions! LOK\'TAR OGAR!' WHERE word_id = 3906;
...
UPDATE trans_words SET content_loc1='Presenting the fierce Grand Champion of Orgrimmar, Mokra the Skullcrusher!' WHERE word_id = 3952;
UPDATE trans_words SET content_loc1='Coming out of the gate is Eressea Dawnsinger, skilled mage and Grand Champion of Silvermoon!' WHERE word_id = 3953;
UPDATE trans_words SET content_loc1='Tall in the saddle of his kodo, here is the venerable Runok Wildmane, Grand Champion of Thunder Bluff!' WHERE word_id = 3954;
UPDATE trans_words SET content_loc1='Entering the arena is the lean and dangerous Zul\'tore, Grand Champion of Sen\'jin!' WHERE word_id = 3955;
UPDATE trans_words SET content_loc1='Representing the tenacity of the Forsaken, here is the Grand Champion of the Undercity, Deathstalker Visceri!' WHERE word_id = 3956;
UPDATE trans_words SET content_loc1='Intruders have entered the masters domain. Signal the alarms!' WHERE word_id = 4003;
...
UPDATE trans_words SET content_loc1='In their initial assault I caught a glimpse of their true leader, a fearsome full-grown Twilight Dragon.' WHERE word_id = 4077;
UPDATE trans_words SET content_loc1='I know not the extent of their plans heroes, but I know this: they cannot be allowed to succeed!' WHERE word_id = 4078;
