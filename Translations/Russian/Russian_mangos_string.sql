...
UPDATE mangos_string SET content_loc8='Разрешенная версия аддона игры %u.' WHERE entry=61;
UPDATE mangos_string SET content_loc8='Пароль:' WHERE entry=62;
UPDATE mangos_string SET content_loc8='Один или несколько параметров имеют неверные значения' WHERE entry=62;
...
UPDATE mangos_string SET content_loc8='GUID объекта: младшие биты %u старшие биты %X' WHERE entry=201;
...
UPDATE mangos_string SET content_loc8='Предмет \'%u\' (с ценой %u) уже в списке продавца.' WHERE entry=210;
...
UPDATE mangos_string SET content_loc8='Предупреждение: Невозможно удалить точку пути из мира с ID: %d' WHERE entry=242;
...
UPDATE mangos_string SET content_loc8='Текст %d (ID: %i): %s' WHERE entry=251;
...
UPDATE mangos_string SET content_loc8='Значение чести %s изменено на %u!' WHERE entry=299;
...
UPDATE mangos_string SET content_loc8='Вы заблокировали чат %s на %u минут. Причина: %s.' WHERE entry=301;
...
UPDATE mangos_string SET content_loc8='Изменения игрока %s будет предложено при следующем входе в мир.' WHERE entry=345;
...
UPDATE mangos_string SET content_loc8='Звание %u (%s) удалено из списка известных званий для игрока %s.' WHERE entry=354;
UPDATE mangos_string SET content_loc8='Звание %u (%s) установлено как текущее звание игрока %s.' WHERE entry=355;
UPDATE mangos_string SET content_loc8='Звание %u (%s) установлено как текущие из списка известных званий для игрока %s.' WHERE entry=355;
...
UPDATE mangos_string SET content_loc8='ID: %d %s effmask: %d Зарядов: %d Стаков: %d Слот: %d Длительность: %d Максимальная длительность: %d %s %s caster: %s guid: %d' WHERE entry=468;
...
UPDATE mangos_string SET content_loc8='Тип сражений на арене сменен на 1v1 для отладки. Не вставайте в очередь в группе.' WHERE entry=737;
UPDATE mangos_string SET content_loc8='Количество игроков на арену установлено в нормальный режим.' WHERE entry=738;
...
UPDATE mangos_string SET content_loc8='Происходит распределение очков Арены в зависимости от рейтинга команд, это может занять несколько минут. Пожалуйста, подождите...' WHERE entry=741;
UPDATE mangos_string SET content_loc8='Распределение очков Арены для игроков...' WHERE entry=742;
UPDATE mangos_string SET content_loc8='Обновление очков Арены для всех персонажей в сети завершено.' WHERE entry=743;
UPDATE mangos_string SET content_loc8='Обновление статистики боев, очков Арены и др. для арена команд, применено обновление характеристик для игроков в сети...' WHERE entry=744;
UPDATE mangos_string SET content_loc8='Обновление завершено.' WHERE entry=745;
UPDATE mangos_string SET content_loc8='Закончено распределение очков Арены.' WHERE entry=746;
...
UPDATE mangos_string SET content_loc8='Сражение в Ущелье Песни Войны начнется через 2 минуты' WHERE entry=753;
UPDATE mangos_string SET content_loc8='%s был разрушен(-а) %s!' WHERE entry=759;
UPDATE mangos_string SET content_loc8='Мастерская %s атакована %s!' WHERE entry=759;
UPDATE mangos_string SET content_loc8='На %s напали! Если ничего не предпринять, его разрушит %s!' WHERE entry=760;
UPDATE mangos_string SET content_loc8='Мастерская %s разрушена %s!' WHERE entry=760;
UPDATE mangos_string SET content_loc8='%s был взят %s!' WHERE entry=761;
UPDATE mangos_string SET content_loc8='%s башня повреждена!' WHERE entry=761;
UPDATE mangos_string SET content_loc8='%s был взят %s!' WHERE entry=762;
UPDATE mangos_string SET content_loc8='%s башня уничтожена!' WHERE entry=762;
UPDATE mangos_string SET content_loc8='%s был взят %s!' WHERE entry=763;
UPDATE mangos_string SET content_loc8='Крепость Озера Ледяных Оков атакуют!' WHERE entry=763;
UPDATE mangos_string SET content_loc8='%s подверглось атаке! Если ничего не предпринять, его захватит %s!' WHERE entry=764;
UPDATE mangos_string SET content_loc8='Озеро Ледяных Оков под контролем %s.' WHERE entry=764;
UPDATE mangos_string SET content_loc8='%s захватил %s! Теперь его припасы пойдут на подкрепление его войск!' WHERE entry=765;
UPDATE mangos_string SET content_loc8='Таймер Озера Ледяных Оков установлен на %s.' WHERE entry=765;
UPDATE mangos_string SET content_loc8='Железный рудник' WHERE entry=766;
UPDATE mangos_string SET content_loc8='Сражение на Озере Ледяных Оков началось.' WHERE entry=766;
UPDATE mangos_string SET content_loc8='Рудник Ледяного Зуба' WHERE entry=767;
UPDATE mangos_string SET content_loc8='Сражение на Озере Ледяных Оков завершено.' WHERE entry=767;
UPDATE mangos_string SET content_loc8='Лазарет Грозовой Вершины' WHERE entry=768;
UPDATE mangos_string SET content_loc8='Состояние Озера Ледяных Оков: Контролирует %s. Таймер: %s. Сражение: %s. Количество игков: (Орда: %u, Альянс: %u)' WHERE entry=768;
UPDATE mangos_string SET content_loc8='Южный оплот Дун Болдара' WHERE entry=769;
UPDATE mangos_string SET content_loc8='Озеро Ледяных Оков отключено.' WHERE entry=769;
UPDATE mangos_string SET content_loc8='Северный оплот Дун Болдара' WHERE entry=770;
UPDATE mangos_string SET content_loc8='Озеро Ледяных Оков включено.' WHERE entry=770;
UPDATE mangos_string SET content_loc8='Кладбище Грозовой Вершины' WHERE entry=771;
UPDATE mangos_string SET content_loc8='Вы достигли Ранга 1: Капрал' WHERE entry=771;
UPDATE mangos_string SET content_loc8='Укрытие Ледяного Крыла' WHERE entry=772;
UPDATE mangos_string SET content_loc8='Вы достигли Ранга 2: Лейтенант' WHERE entry=772;
...
UPDATE mangos_string SET content_loc8='Тест Арены %s' WHERE entry=785;
UPDATE mangos_string SET content_loc8='Сражение на Альтеракской долине началось!' WHERE entry=786;
UPDATE mangos_string SET content_loc8='|cffff0000[Авто-объявление]:|r' WHERE entry=786;
UPDATE mangos_string SET content_loc8='Команда Альянса бежит без подкрепления!' WHERE entry=787;
UPDATE mangos_string SET content_loc8='|cffffff00[|c1f40af20Объявление от|r |cffff0000%s|cffffff00]:|r %s|r' WHERE entry=787;
...
UPDATE mangos_string SET content_loc8='Внимание: вы попали в зону, не предназначенную для полетов, и будете высажены со своего транспорта!' WHERE entry=816;
UPDATE mangos_string SET content_loc8='Entry %u не найден в таблице creature_template.' WHERE entry=817;
UPDATE mangos_string SET content_loc8='Внимание: вы попали в зону, не предназначенную для полетов, и будете высажены со своего транспорта!' WHERE entry=817;
...
UPDATE mangos_string SET content_loc8='-[         Аккаунт][   Персонаж][             IP][Карта][Зона][Exp][ГМ Ур]-' WHERE entry=1010;
...
UPDATE mangos_string SET content_loc8='-======================== Игроки онлайн =======================-' WHERE entry=1015;
...
UPDATE mangos_string SET content_loc8='Персонажа \'%s\' (GUID: %u Аккаунт %u) невозможно восстановить: аккаунт не существует!' WHERE entry=1023;
...
UPDATE mangos_string SET content_loc8='Персонажа \'%s\' (GUID: %u Аккаунт %u) невозможно восстановить: новое имя уже используется!' WHERE entry=1025;
...
UPDATE mangos_string SET content_loc8='Забаненных персонажей на текущий момент:' WHERE entry=1132;
UPDATE mangos_string SET content_loc8='Следовать за существом %s (lowguid %u)' WHERE entry=1133;
UPDATE mangos_string SET content_loc8='|   Персонаж   |   Дата Бана    |   Дата Разбана  |  Выдан ГМом   |   Причина Бана  |' WHERE entry=1133;
UPDATE mangos_string SET content_loc8='Следовать за <ПУСТО>' WHERE entry=1134;
UPDATE mangos_string SET content_loc8='Отправка тикетов не допускается.' WHERE entry=1134;
...
UPDATE mangos_string SET content_loc8='Итог' WHERE entry=1164;
...
UPDATE mangos_string SET content_loc8='|            | Альянс |   Орда  | Нейтральный  |  Кол-во  |' WHERE entry=1166;
UPDATE mangos_string SET content_loc8='Библиотека скриптов содержит неверный список функций (устарела?).' WHERE entry=1167;
UPDATE mangos_string SET content_loc8='Альянс/Орда/Нейтральный/Кол-во' WHERE entry=1167;
UPDATE mangos_string SET content_loc8='Библиотека скриптов перезагружена.' WHERE entry=1168;
UPDATE mangos_string SET content_loc8='Серый' WHERE entry=1168;
...
UPDATE mangos_string SET content_loc8='Фиолетовые' WHERE entry=1172;
UPDATE mangos_string SET content_loc8='Оранжевые' WHERE entry=1173;
UPDATE mangos_string SET content_loc8='Желтые' WHERE entry=1174;
...
UPDATE mangos_string SET content_loc8='Вы хотите просмотреть ролик %u, но его не существует.' WHERE entry=1201;
