...
UPDATE locales_page_text SET text_loc9='. . .la più strana ed incontrollabile delle sensazioni.  Non mi sono mai sentito come oggi.  Mentre tenevo la lezione di storia a Giles, Tilloa era fuori e stava curando il giardino dei fiori.  Dopo pochi minuti è tornata in casa e ha mezzo una begonia rossa nella mia mano aperta e mi ha sorriso in un tal modo che il mio cuore si è messo a tremare nel mio petto. . . .' WHERE entry=24; /* text: . . .most strange and uncontrollable feeling.  Never have I felt the way I did today.  Whilst assisting Giles with his history lesson, Tilloa was outside tending to the flower garden.  After a few minutes she came inside and placed a scarlet begonia in my open palm and smiled at me in such a way that my heart felt as though it was trembling within my chest. . . . */
...
UPDATE locales_page_text SET text_loc9='Servitori, ascoltate la chiamata del padrone! Il Re dei Lich ha dato a Drakuru il controllo di tutte quante le armate del Flagello a Zul\'Drak. Teniamo l\'ordine di accidere tutti quanti!$b$bDEVONO SCHIATTARE TUTTI QUANTI!$b$bImpacchetteremo tutti quanti i cadaveri nei Campi Sterili e li manderemo ai guaglioni del Principe Navarius a Zeramas, perché diventino parte del Flagello! Sotto il comando di Drakuru nun si spreca niente!$b$bPresto berremo il sangue dei profeti e diventeremo più forti che mai! Zul\'Drak e Gundrak cadranno sotto il Flagello!' WHERE entry=3279; /* text: Minions be hearin\' da call of your masta! Da Lich King be givin\' Drakuru full control of da armies of da Scourge in Zul\'Drak. We be commanded ta kill everyting.$B$BEVERYTING MUST DIE!$B$BWe be processin\' all da corpses in da Dead Fields and sendin\' em up ta Prince Navarius\' crew in  Zeramas for Scourgin\'! Notin\' goes ta waste on Drakuru\'s watch!$B$BSoon we be drinkin\' da blood of da prophets ta become stronger dan eva before! Zul\'Drak and Gundrak gonna fall to da Scourge! */
