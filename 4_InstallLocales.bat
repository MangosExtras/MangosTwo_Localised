...
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\French\French_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\German\German_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Korean\Korean_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Chinese\Chinese_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Taiwanese\Taiwanese_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Spanish\Spanish_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Spanish_South_American\SpanishSA_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Russian\Russian_achievement_reward.sql
echo  .... Command (2/15)
...
echo  .... Achievement (1/15)
%mysql%mysql -q -s -h %svr% --user=%user% --password=%pass% --port=%port% %wdb% < Translations\Italian\Italian_achievement_reward.sql
echo  .... Command (2/15)
